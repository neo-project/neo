        ...
        public static TestWalletModel CreateTestWalletModel() =>
            new()
            {
                ...
                Extra = new ProtocolOptionsModel()
                {
                    ...
                    {
                        { Hardfork.HF_Aspidochelone, 1730000u },
                        { Hardfork.HF_Basilisk, 4120000u },
                        { Hardfork.HF_Cockatrice, 5450000u },
                        { Hardfork.HF_Domovoi, 5570000u },
                        { Hardfork.HF_Echidna, 7300000u },
                    },
