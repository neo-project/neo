...
namespace Neo.Build.Core.Tests.Exceptions
{
    ...
    public class UT_NeoBuildException
    {
        ...
        public void TestIsPropertiesSet()
        {
            ...
            Assert.AreEqual($"Error {exception.ErrorCode} Hello World", exception.Message);
            ...
            Assert.AreEqual($"Error {exceptionInterface.ErrorCode} Hello World", exceptionInterface.Message);

            // System.Exception
            Assert.AreEqual(NeoBuildErrorCodes.General.InternalException, exceptionBase.HResult);
            Assert.AreEqual($"Error {NeoBuildErrorCodes.StringPrefix}{(uint)exceptionBase.HResult} Hello World", exceptionBase.Message);
        ...
        public void TestIsPropertiesSetForSystemException()
        {
            ...
            Assert.AreEqual($"Error {neoException1.ErrorCode} Hello World", neoException1.Message);
            ...
            Assert.AreEqual($"Error {exceptionInterface1.ErrorCode} Hello World", exceptionInterface1.Message);
            ...
            Assert.AreEqual($"Error {neoException2.ErrorCode} Hello World", neoException2.Message);
            ...
            Assert.AreEqual($"Error {exceptionInterface2.ErrorCode} Hello World", exceptionInterface2.Message);
        }
    }
}
