...
namespace Neo.Cryptography.BLS12_381.Tests
{
    ...
    public class UT_Fp2
    {
        ...
        {
            var a = new Fp2(
                Fp.FromRawUnchecked([1, 2, 3, 4, 5, 6]),
                Fp.FromRawUnchecked([7, 8, 9, 10, 11, 12])
            );
            var b = new Fp2(
                Fp.FromRawUnchecked([13, 14, 15, 16, 17, 18]),
                Fp.FromRawUnchecked([19, 20, 21, 22, 23, 24])
            );
        ...
        public void TestEquality()
        {
            ...
            Assert.IsTrue(IsEqual(
                new Fp2(Fp.FromRawUnchecked([1, 2, 3, 4, 5, 6]), Fp.FromRawUnchecked([7, 8, 9, 10, 11, 12])),
                new Fp2(Fp.FromRawUnchecked([1, 2, 3, 4, 5, 6]), Fp.FromRawUnchecked([7, 8, 9, 10, 11, 12]))
            ));

            Assert.IsFalse(IsEqual(
                new Fp2(Fp.FromRawUnchecked([2, 2, 3, 4, 5, 6]), Fp.FromRawUnchecked([7, 8, 9, 10, 11, 12])),
                new Fp2(Fp.FromRawUnchecked([1, 2, 3, 4, 5, 6]), Fp.FromRawUnchecked([7, 8, 9, 10, 11, 12]))
            ));

            Assert.IsFalse(IsEqual(
                new Fp2(Fp.FromRawUnchecked([1, 2, 3, 4, 5, 6]), Fp.FromRawUnchecked([2, 8, 9, 10, 11, 12])),
                new Fp2(Fp.FromRawUnchecked([1, 2, 3, 4, 5, 6]), Fp.FromRawUnchecked([7, 8, 9, 10, 11, 12]))
            ));
        }
        ...
        {
            var a = new Fp2(Fp.FromRawUnchecked(
            [
            ...
            var b = new Fp2(Fp.FromRawUnchecked(
            [
        ...
        public void TestMultiplication()
        {
            ...
            var c = new Fp2(Fp.FromRawUnchecked(
            [
        ...
        public void TestSqrt()
        {
            ...
            // is nonsquare.
            Assert.ThrowsExactly<ArithmeticException>(() => _ = new Fp2(Fp.FromRawUnchecked(
                [
        ...
        public void TestLexicographicLargest()
        {
            ...
            Assert.IsTrue(new Fp2(Fp.FromRawUnchecked(
            [
                0x1128_ecad_6754_9455,
                0x9e7a_1cff_3a4e_a1a8,
                0xeb20_8d51_e08b_cf27,
            ...
            Assert.IsFalse(new Fp2(-Fp.FromRawUnchecked(
            [
                0x1128_ecad_6754_9455,
                0x9e7a_1cff_3a4e_a1a8,
                0xeb20_8d51_e08b_cf27,
