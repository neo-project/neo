...
public class UT_Fp12
{
    ...
    {
        var a = new Fp12(new Fp6(new Fp2(Fp.FromRawUnchecked(
        [
        ...
        var b = new Fp12(new Fp6(new Fp2(Fp.FromRawUnchecked(
        [
            0x47f9_cb98_b1b8_2d58,
            0x5fe9_11eb_a3aa_1d9d,
            0x96bf_1b5f_4dd8_1db3,
        ...
        var c = new Fp12(new Fp6(new Fp2(Fp.FromRawUnchecked(
        [
