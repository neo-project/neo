...
namespace Neo.Cryptography.BLS12_381.Tests
{
    ...
    public class UT_Fp
    {
        ...
        public void TestEquality()
        {
            ...
            Assert.IsTrue(IsEqual(Fp.FromRawUnchecked([1, 2, 3, 4, 5, 6]), Fp.FromRawUnchecked([1, 2, 3, 4, 5, 6])));

            Assert.IsFalse(IsEqual(Fp.FromRawUnchecked([7, 2, 3, 4, 5, 6]), Fp.FromRawUnchecked([1, 2, 3, 4, 5, 6])));
            Assert.IsFalse(IsEqual(Fp.FromRawUnchecked([1, 7, 3, 4, 5, 6]), Fp.FromRawUnchecked([1, 2, 3, 4, 5, 6])));
            Assert.IsFalse(IsEqual(Fp.FromRawUnchecked([1, 2, 7, 4, 5, 6]), Fp.FromRawUnchecked([1, 2, 3, 4, 5, 6])));
            Assert.IsFalse(IsEqual(Fp.FromRawUnchecked([1, 2, 3, 7, 5, 6]), Fp.FromRawUnchecked([1, 2, 3, 4, 5, 6])));
            Assert.IsFalse(IsEqual(Fp.FromRawUnchecked([1, 2, 3, 4, 7, 6]), Fp.FromRawUnchecked([1, 2, 3, 4, 5, 6])));
            Assert.IsFalse(IsEqual(Fp.FromRawUnchecked([1, 2, 3, 4, 5, 7]), Fp.FromRawUnchecked([1, 2, 3, 4, 5, 6])));
        }

        [TestMethod]
        public void TestConditionalSelection()
        {
            Fp a = Fp.FromRawUnchecked([1, 2, 3, 4, 5, 6]);
            Fp b = Fp.FromRawUnchecked([7, 8, 9, 10, 11, 12]);
        ...
        public void TestConstructor()
        {
            ...
            Assert.AreEqual(-Fp.One, Fp.FromBytes(
            [
            ...
            Assert.ThrowsExactly<FormatException>(() => _ = Fp.FromBytes(
            [
        ...
        public void TestLexicographicLargest()
        {
            ...
            Assert.IsFalse(Fp.FromRawUnchecked(
            [
            ...
            Assert.IsTrue(Fp.FromRawUnchecked(
            [
