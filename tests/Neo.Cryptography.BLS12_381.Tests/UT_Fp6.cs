...
public class UT_Fp6
{
    ...
    {
        var a = new Fp6(new Fp2(Fp.FromRawUnchecked([
        ...
        ])), c1: new Fp2(Fp.FromRawUnchecked([
        ...
        var b = new Fp6(new Fp2(Fp.FromRawUnchecked([
        ...
        var c = new Fp6(new Fp2(Fp.FromRawUnchecked([
