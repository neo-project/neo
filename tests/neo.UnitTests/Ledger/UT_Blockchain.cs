...
namespace Neo.UnitTests.Ledger
{
    ...
    public class UT_Blockchain : TestKit
    {
        ...
        {
            Blockchain.Singleton.CurrentBlockHash.Should().Be(UInt256.Parse("0xe1699b24ca8701519915d6d0cc0a2a10c6c8bc228b6db7e41b98642c6089abff"));
        }

        [TestMethod]
        public void TestGetCurrentHeaderHash()
        {
            Blockchain.Singleton.CurrentHeaderHash.Should().Be(UInt256.Parse("0xe1699b24ca8701519915d6d0cc0a2a10c6c8bc228b6db7e41b98642c6089abff"));
        }
        ...
        {
            Blockchain.Singleton.GetBlockHash(0).Should().Be(UInt256.Parse("0xe1699b24ca8701519915d6d0cc0a2a10c6c8bc228b6db7e41b98642c6089abff"));
