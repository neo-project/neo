...
namespace Neo.UnitTests.Ledger
{
    ...
    public class UT_Blockchain : TestKit
    {
        ...
        {
            Blockchain.Singleton.CurrentBlockHash.Should().Be(UInt256.Parse("0xbd8ab342d54270a30b247e0e415fecc2650d0019cffec045cdb04272646b8006"));
        }

        [TestMethod]
        public void TestGetCurrentHeaderHash()
        {
            Blockchain.Singleton.CurrentHeaderHash.Should().Be(UInt256.Parse("0xbd8ab342d54270a30b247e0e415fecc2650d0019cffec045cdb04272646b8006"));
        }
        ...
        {
            Blockchain.Singleton.GetBlockHash(0).Should().Be(UInt256.Parse("0xbd8ab342d54270a30b247e0e415fecc2650d0019cffec045cdb04272646b8006"));
