...
namespace Neo.UnitTests.Network.P2P.Payloads
{
    ...
    public class UT_VersionPayload
    {
        ...
        {
            var test = VersionPayload.Create(123, "neo3", new NodeCapability[] { new ServerCapability(NodeCapabilityType.TcpServer, 22) });
            ...
            Assert.ThrowsException<FormatException>(() => VersionPayload.Create(123, "neo3",
                new NodeCapability[] {
