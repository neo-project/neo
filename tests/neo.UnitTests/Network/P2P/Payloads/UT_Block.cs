...
namespace Neo.UnitTests.Network.P2P.Payloads
{
    ...
    public class UT_Block
    {
        ...
        public void Serialize()
        {
            ...
            var hex = "";
        ...
        public void ToJson()
        {
            ...
            jObj["hash"].AsString().Should().Be("0xcaf0822d38f98603ee82e2b730066ac1bbdc2c07925495fa2967972f33c66b30");
            ...
            jObj["merkleroot"].AsString().Should().Be("0xcf5a4761e43e482b939b616d7d604e614df0b63fb20e208bc20c486969d687e0");
            ...
            txObj[0]["hash"].AsString().Should().Be("0x11a2d877f486015f50d5cd53e62c772ab39d05306150ef8f72d8bff215c47bea");
            txObj[0]["size"].AsNumber().Should().Be(45);
