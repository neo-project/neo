...
namespace Neo.UnitTests.Network.P2P.Payloads
{
    ...
    public class UT_Header
    {
        ...
        public void Size_Get()
        {
            ...
            // header 1
            uut.Size.Should().Be(109); // 105 + nonce
        }
        ...
        {
            UInt256 val256 = UInt256.Zero;
            TestUtils.SetupHeaderWithValues(new Header(), val256, out UInt256 merkRoot, out UInt160 val160, out ulong timestampVal, out uint indexVal, out uint nonceVal, out Witness scriptVal);
            ...
            AssertStandardHeaderTestVals(val256, merkRoot, val160, timestampVal, indexVal, nonceVal, scriptVal);
        }

        private void AssertStandardHeaderTestVals(UInt256 val256, UInt256 merkRoot, UInt160 val160, ulong timestampVal, uint indexVal, uint nonceVal, Witness scriptVal)
        {
