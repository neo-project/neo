...
namespace Neo.UnitTests.SmartContract
{
    ...
    public class UT_ContractParameterContext
    {
        ...
        public void TestGetComplete()
        {
            ...
            var context = new ContractParametersContext(snapshot, tx, ProtocolSettings.Default.Magic);
        ...
        public void TestToString()
        {
            ...
            str.Should().Be(@"{""type"":""Neo.Network.P2P.Payloads.Transaction"",""data"":""AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAFmUJDLobcPtqo9vZKIdjXsd8fVGwEAARI="",""items"":{},""network"":" + ProtocolSettings.Default.Magic + "}");
        }
        ...
        public void TestAdd()
        {
            ...
            var context1 = new ContractParametersContext(snapshot, tx, ProtocolSettings.Default.Magic);
            ...
            var context2 = new ContractParametersContext(snapshot, tx, ProtocolSettings.Default.Magic);
        ...
        public void TestAddSignature()
        {
            ...
            context = new ContractParametersContext(snapshot, tx, ProtocolSettings.Default.Magic);
