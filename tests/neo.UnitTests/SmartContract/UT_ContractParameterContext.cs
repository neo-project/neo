...
namespace Neo.UnitTests.SmartContract
{
    ...
    public class UT_ContractParameterContext
    {
        ...
        public void TestToString()
        {
            ...
            str.Should().Be(@"{""type"":""Neo.Network.P2P.Payloads.Transaction"",""hex"":""AAAAAAAAAAAAAAAAAAAAAAABZlCQy6G3D7aqPb2SiHY17HfH1RsBAAEA"",""items"":{}}");
        }

        [TestMethod]
        public void TestParse()
        {
            var ret = ContractParametersContext.Parse("{\"type\":\"Neo.Network.P2P.Payloads.Transaction\",\"hex\":\"AAAAAAAAAAAAAAAAAAAAAAABZlCQy6G3D7aqPb2SiHY17HfH1RsBAAEA\",\"items\":{\"0xbecaad15c0ea585211faf99738a4354014f177f2\":{\"script\":\"IQJv8DuUkkHOHa3UNRnmlg4KhbQaaaBcMoEDqivOFZTKFmh0dHaq\",\"parameters\":[{\"type\":\"Signature\",\"value\":\"AQ==\"}]}}}");
