...
namespace Neo.UnitTests.SmartContract
{
    public partial class UT_InteropService
    {
        ...
        public void TestAccount_IsStandard()
        {
            ...
            InteropService.Invoke(engine, InteropService.System_Contract_IsStandard).Should().BeTrue();
            engine.CurrentContext.EvaluationStack.Pop().ToBoolean().Should().BeTrue();
        ...
        public void TestContract_Create()
        {
            ...
            InteropService.Invoke(engine, InteropService.System_Contract_Create).Should().BeFalse();
            ...
            engine.CurrentContext.EvaluationStack.Push(manifest.ToString());
            engine.CurrentContext.EvaluationStack.Push(script);
            InteropService.Invoke(engine, InteropService.System_Contract_Create).Should().BeTrue();
        ...
        public void TestContract_Update()
        {
            ...
            var script = new byte[1024 * 1024 + 1];
            engine.CurrentContext.EvaluationStack.Push(script);
            InteropService.Invoke(engine, InteropService.System_Contract_Update).Should().BeFalse();
            ...
            engine.CurrentContext.EvaluationStack.Push(manifest.ToString());
            engine.CurrentContext.EvaluationStack.Push(script);
            InteropService.Invoke(engine, InteropService.System_Contract_Update).Should().BeTrue();
        ...
        public void TestEnumerator_Create()
        {
            ...
            InteropService.Invoke(engine, InteropService.System_Enumerator_Create).Should().BeTrue();
        ...
        public void TestEnumerator_Next()
        {
            ...
            InteropService.Invoke(engine, InteropService.System_Enumerator_Next).Should().BeTrue();
            engine.CurrentContext.EvaluationStack.Pop().ToBoolean().Should().BeTrue();

            engine.CurrentContext.EvaluationStack.Push(1);
            InteropService.Invoke(engine, InteropService.System_Enumerator_Next).Should().BeFalse();
        }
        ...
        public void TestEnumerator_Value()
        {
            ...
            InteropService.Invoke(engine, InteropService.System_Enumerator_Value).Should().BeTrue();
            engine.CurrentContext.EvaluationStack.Pop().GetSpan().ToHexString().Should().Be(new byte[] { 0x01 }.ToHexString());

            engine.CurrentContext.EvaluationStack.Push(1);
            InteropService.Invoke(engine, InteropService.System_Enumerator_Value).Should().BeFalse();
        }
        ...
        public void TestEnumerator_Concat()
        {
            ...
            InteropService.Invoke(engine, InteropService.System_Enumerator_Concat).Should().BeTrue();
        ...
        public void TestIterator_Create()
        {
            ...
            engine.CurrentContext.EvaluationStack.Push(arr);
            InteropService.Invoke(engine, InteropService.System_Iterator_Create).Should().BeTrue();
            ...
            InteropService.Invoke(engine, InteropService.System_Iterator_Create).Should().BeFalse();
        ...
        public void TestIterator_Key()
        {
            ...
            wrapper.Next();
            engine.CurrentContext.EvaluationStack.Push(new InteropInterface<ArrayWrapper>(wrapper));
            InteropService.Invoke(engine, InteropService.System_Iterator_Key).Should().BeTrue();
            engine.CurrentContext.EvaluationStack.Pop().GetBigInteger().Should().Be(0);

            engine.CurrentContext.EvaluationStack.Push(1);
            InteropService.Invoke(engine, InteropService.System_Iterator_Key).Should().BeFalse();
        }
        ...
        public void TestIterator_Keys()
        {
            ...
            var wrapper = new ArrayWrapper(arr);
            engine.CurrentContext.EvaluationStack.Push(new InteropInterface<ArrayWrapper>(wrapper));
            InteropService.Invoke(engine, InteropService.System_Iterator_Keys).Should().BeTrue();
            ...
            engine.CurrentContext.EvaluationStack.Push(1);
            InteropService.Invoke(engine, InteropService.System_Iterator_Keys).Should().BeFalse();
        }
        ...
        public void TestIterator_Values()
        {
            ...
            var wrapper = new ArrayWrapper(arr);
            engine.CurrentContext.EvaluationStack.Push(new InteropInterface<ArrayWrapper>(wrapper));
            InteropService.Invoke(engine, InteropService.System_Iterator_Values).Should().BeTrue();
            ...
            engine.CurrentContext.EvaluationStack.Push(1);
            InteropService.Invoke(engine, InteropService.System_Iterator_Values).Should().BeFalse();
        }
        ...
        public void TestIterator_Concat()
        {
            ...
            engine.CurrentContext.EvaluationStack.Push(new InteropInterface<ArrayWrapper>(wrapper2));
            engine.CurrentContext.EvaluationStack.Push(new InteropInterface<ArrayWrapper>(wrapper1));
            InteropService.Invoke(engine, InteropService.System_Iterator_Concat).Should().BeTrue();
        ...
        public void TestJson_Deserialize()
        {
            var engine = GetEngine();
            engine.CurrentContext.EvaluationStack.Push("1");
            InteropService.Invoke(engine, InteropService.System_Json_Deserialize).Should().BeTrue();
        ...
        public void TestJson_Serialize()
        {
            var engine = GetEngine();
            engine.CurrentContext.EvaluationStack.Push(1);
            InteropService.Invoke(engine, InteropService.System_Json_Serialize).Should().BeTrue();
            var ret = engine.CurrentContext.EvaluationStack.Pop();
