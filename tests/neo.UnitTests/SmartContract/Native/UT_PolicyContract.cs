...
namespace Neo.UnitTests.SmartContract.Native
{
    ...
    public class UT_PolicyContract
    {
        ...
        public void Check_SetMaxBlockSize()
        {
            ...
            var ret = NativeContract.Policy.Call(snapshot, new ManualWitness(null),
            ...
            ret = NativeContract.Policy.Call(snapshot, new ManualWitness(committeeMultiSigAddr),
        ...
        public void Check_SetMaxTransactionsPerBlock()
        {
            ...
            var ret = NativeContract.Policy.Call(snapshot, new ManualWitness(),
            ...
            ret = NativeContract.Policy.Call(snapshot, new ManualWitness(NativeContract.NEO.GetCommitteeAddress(snapshot)),
                "setMaxTransactionsPerBlock", new ContractParameter(ContractParameterType.Integer) { Value = 1 });
            ret.Should().BeOfType<VM.Types.Boolean>();
            ret.GetBoolean().Should().BeTrue();
        ...
        public void Check_Block_UnblockAccount()
        {
            ...
            ret = NativeContract.Policy.Call(snapshot, new ManualWitness(),
