...
namespace Neo.UnitTests.SmartContract.Native
{
    ...
    public class UT_NativeContract
    {
        ...
        public void TestInvoke()
        {
            ...
            ApplicationEngine engine = ApplicationEngine.Create(TriggerType.SystemPersist, null, snapshot, 0);
        ...
        public void TestOnPersistWithArgs()
        {
            ...
            ApplicationEngine engine2 = ApplicationEngine.Create(TriggerType.SystemPersist, null, snapshot, 0);
