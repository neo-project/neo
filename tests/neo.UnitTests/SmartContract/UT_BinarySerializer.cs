...
namespace Neo.UnitTests.SmartContract
{
    ...
    {
        private const int MaxItemSize = 1024 * 1024, MaxArraySize = 64;

        [TestMethod]
        public void TestSerialize()
        {
            byte[] result1 = BinarySerializer.Serialize(new byte[5], MaxItemSize, MaxArraySize, MaxItemSize);
            ...
            byte[] result2 = BinarySerializer.Serialize(true, MaxItemSize, MaxArraySize, MaxItemSize);
            byte[] expectedArray2 = new byte[] {
                        0x20, 0x01
                    };
            Assert.AreEqual(Encoding.Default.GetString(expectedArray2), Encoding.Default.GetString(result2));

            byte[] result3 = BinarySerializer.Serialize(1, MaxItemSize, MaxArraySize, MaxItemSize);
            ...
            Action action4 = () => BinarySerializer.Serialize(stackItem4, MaxItemSize, MaxArraySize, MaxItemSize);
            ...
            byte[] result6 = BinarySerializer.Serialize(stackItem62, MaxItemSize, MaxArraySize, MaxItemSize);
            ...
            byte[] result7 = BinarySerializer.Serialize(stackItem72, MaxItemSize, MaxArraySize, MaxItemSize);
            ...
            byte[] result8 = BinarySerializer.Serialize(stackItem82, MaxItemSize, MaxArraySize, MaxItemSize);
            ...
            Action action9 = () => BinarySerializer.Serialize(stackItem91, MaxItemSize, MaxArraySize, MaxItemSize);
            action9.Should().Throw<NotSupportedException>();

            VM.Types.Array stackItem10 = new VM.Types.Array();
            stackItem10.Add(stackItem10);
            Action action10 = () => BinarySerializer.Serialize(stackItem10, MaxItemSize, MaxArraySize, MaxItemSize);
        ...
        public void TestDeserializeStackItem()
        {
            ...
            byte[] byteArray1 = BinarySerializer.Serialize(stackItem1, MaxItemSize, MaxArraySize, MaxItemSize);
            ...
            byte[] byteArray2 = BinarySerializer.Serialize(stackItem2, MaxItemSize, MaxArraySize, MaxItemSize);
            ...
            byte[] byteArray3 = BinarySerializer.Serialize(stackItem3, MaxItemSize, MaxArraySize, MaxItemSize);
            StackItem result3 = BinarySerializer.Deserialize(byteArray3, 2048, (uint)byteArray3.Length);
            Assert.AreEqual(stackItem3, result3);

            byte[] byteArray4 = BinarySerializer.Serialize(1, MaxItemSize, MaxArraySize, MaxItemSize);
            byteArray4[0] = 0x40;
            ...
            byte[] byteArray5 = BinarySerializer.Serialize(stackItem52, MaxItemSize, MaxArraySize, MaxItemSize);
            ...
            byte[] byteArray6 = BinarySerializer.Serialize(stackItem62, MaxItemSize, MaxArraySize, MaxItemSize);
            ...
            byte[] byteArray7 = BinarySerializer.Serialize(stackItem72, MaxItemSize, MaxArraySize, MaxItemSize);
