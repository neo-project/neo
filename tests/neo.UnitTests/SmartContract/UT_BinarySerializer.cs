...
namespace Neo.UnitTests.SmartContract
{
    ...
    public class UT_BinarySerializer
    {
        ...
        public void TestDeserializeStackItem()
        {
            ...
            StackItem result1 = BinarySerializer.Deserialize(byteArray1, 2048, 2048);
            ...
            StackItem result2 = BinarySerializer.Deserialize(byteArray2, 2048, 2048);
            ...
            StackItem result3 = BinarySerializer.Deserialize(byteArray3, 2048, 2048);
            Assert.AreEqual(stackItem3, result3);

            byte[] byteArray4 = BinarySerializer.Serialize(1, MaxItemSize);
            byteArray4[0] = 0x40;
            Action action4 = () => BinarySerializer.Deserialize(byteArray4, 2048, 2048);
            ...
            StackItem result5 = BinarySerializer.Deserialize(byteArray5, 2048, 2048);
            ...
            StackItem result6 = BinarySerializer.Deserialize(byteArray6, 2048, 2048);
            ...
            StackItem result7 = BinarySerializer.Deserialize(byteArray7, 2048, 2048);
