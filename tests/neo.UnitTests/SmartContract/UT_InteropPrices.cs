...
namespace Neo.UnitTests.SmartContract
{
    ...
    public class UT_InteropPrices
    {
        ...
        public void ApplicationEngineFixedPrices()
        {
            ...
            using (ApplicationEngine ae = new ApplicationEngine(TriggerType.Application, null, snapshot, 0))
            {
                ae.LoadScript(SyscallSystemRuntimeCheckWitnessHash);
                NativeContract.Fee.GetSyscallPrice(InteropService.Runtime.CheckWitness, snapshot, ae.CurrentContext.EvaluationStack).Should().Be(0_00030000L);
            }
            ...
            using (ApplicationEngine ae = new ApplicationEngine(TriggerType.Application, null, null, 0))
            {
                ...
                NativeContract.Fee.GetSyscallPrice(InteropService.Storage.GetContext, snapshot, ae.CurrentContext.EvaluationStack).Should().Be(0_00000400L);
            }
            ...
            using (ApplicationEngine ae = new ApplicationEngine(TriggerType.Application, null, null, 0))
            {
                ...
                NativeContract.Fee.GetSyscallPrice(InteropService.Storage.Get, snapshot, ae.CurrentContext.EvaluationStack).Should().Be(0_01000000L);
            }
        }
        ...
        public void ApplicationEngineVariablePrices()
        {
            ...
            using (ApplicationEngine ae = new ApplicationEngine(TriggerType.Application, null, snapshot, 0, testMode: true))
            {
                ...
                debugger.StepInto(); // PUSHDATA1
                NativeContract.Fee.GetSyscallPrice(InteropService.Contract.Create, snapshot, ae.CurrentContext.EvaluationStack).Should().Be(0_00300000L);
            }
            ...
            using (ApplicationEngine ae = new ApplicationEngine(TriggerType.Application, null, snapshot, 0, testMode: true))
            {
                ...
                NativeContract.Fee.GetSyscallPrice(InteropService.Storage.Put, snapshot, ae.CurrentContext.EvaluationStack).Should().Be(200000L);
            }
            ...
            using (ApplicationEngine ae = new ApplicationEngine(TriggerType.Application, null, snapshot, 0, testMode: true))
            {
                ...
                debugger.StepInto(); // push 03 (length 1)
                debugger.StepInto(); // push 00
                NativeContract.Fee.GetSyscallPrice(InteropService.Storage.PutEx, snapshot, ae.CurrentContext.EvaluationStack).Should().Be(200000L);
            }
        }
    }
}
