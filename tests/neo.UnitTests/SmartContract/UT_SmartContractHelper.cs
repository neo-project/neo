...
namespace Neo.UnitTests.SmartContract
{
    ...
    public class UT_SmartContractHelper
    {
        ...
        public void TestVerifyWitnesses()
        {
            ...
            Assert.AreEqual(false, Neo.SmartContract.Helper.VerifyWitnesses(new Header() { PrevHash = index1 }, snapshot1, 3));
            ...
            Assert.AreEqual(false, Neo.SmartContract.Helper.VerifyWitnesses(header2, snapshot2, 3));
            ...
            Assert.AreEqual(false, Neo.SmartContract.Helper.VerifyWitnesses(header3, snapshot3, 3));
