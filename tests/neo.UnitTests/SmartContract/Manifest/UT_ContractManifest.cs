...
namespace Neo.UnitTests.SmartContract.Manifest
{
    ...
    public class UT_ContractManifest
    {
        ...
        {
            var json = @"{""hash"":""0x0000000000000000000000000000000000000000"",""groups"":[],""features"":{""storage"":false,""payable"":false},""supportedstandards"":[],""permissions"":[{""contract"":""*"",""methods"":""*""}],""trusts"":[],""safemethods"":[],""extra"":null}";
        ...
        {
            var json = @"{""hash"":""0x0000000000000000000000000000000000000000"",""groups"":[],""features"":{""storage"":true,""payable"":true},""supportedstandards"":[],""permissions"":[{""contract"":""*"",""methods"":""*""}],""trusts"":[],""safemethods"":[],""extra"":null}";
            var manifest = ContractManifest.Parse(json);
        ...
        {
            var json = @"{""hash"":""0x0000000000000000000000000000000000000000"",""groups"":[],""features"":{""storage"":false,""payable"":false},""supportedstandards"":[],""permissions"":[{""contract"":""0x0000000000000000000000000000000000000000"",""methods"":[""method1"",""method2""]}],""trusts"":[],""safemethods"":[],""extra"":null}";
            var manifest = ContractManifest.Parse(json);
            Assert.AreEqual(manifest.ToString(), json);
        ...
        {
            var json = @"{""hash"":""0x0000000000000000000000000000000000000000"",""groups"":[],""features"":{""storage"":false,""payable"":false},""supportedstandards"":[],""permissions"":[{""contract"":""*"",""methods"":""*""}],""trusts"":[],""safemethods"":[""balanceOf""],""extra"":null}";
            var manifest = ContractManifest.Parse(json);
            Assert.AreEqual(manifest.ToString(), json);
        ...
        {
            var json = @"{""hash"":""0x0000000000000000000000000000000000000000"",""groups"":[],""features"":{""storage"":false,""payable"":false},""supportedstandards"":[],""permissions"":[{""contract"":""*"",""methods"":""*""}],""trusts"":[""0x0000000000000000000000000000000000000001""],""safemethods"":[],""extra"":null}";
            var manifest = ContractManifest.Parse(json);
            Assert.AreEqual(manifest.ToString(), json);
        ...
        {
            var json = @"{""hash"":""0x0000000000000000000000000000000000000000"",""groups"":[{""pubkey"":""03b209fd4f53a7170ea4444e0cb0a6bb6a53c2bd016926989cf85f9b0fba17a70c"",""signature"":""QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQQ==""}],""features"":{""storage"":false,""payable"":false},""supportedstandards"":[],""permissions"":[{""contract"":""*"",""methods"":""*""}],""trusts"":[],""safemethods"":[],""extra"":null}";
            var manifest = ContractManifest.Parse(json);
            Assert.AreEqual(manifest.ToString(), json);
        ...
        {
            var json = @"{""hash"":""0x0000000000000000000000000000000000000000"",""groups"":[],""features"":{""storage"":false,""payable"":false},""supportedstandards"":[],""permissions"":[{""contract"":""*"",""methods"":""*""}],""trusts"":[],""safemethods"":[],""extra"":{""key"":""value""}}";
            var manifest = ContractManifest.Parse(json);
