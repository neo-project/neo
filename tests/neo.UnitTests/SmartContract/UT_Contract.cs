...
namespace Neo.UnitTests.SmartContract
{
    ...
    public class UT_Contract
    {
        ...
        public void TestCreateMultiSigContract()
        {
            ...
            byte[] expectedArray = new byte[79];
            expectedArray[0] = (byte)OpCode.PUSH2;
            expectedArray[1] = (byte)OpCode.PUSH2;
            expectedArray[2] = (byte)OpCode.PUSHDATA1;
            expectedArray[3] = 0x21;
            Array.Copy(publicKeys[0].EncodePoint(true), 0, expectedArray, 4, 33);
            expectedArray[37] = (byte)OpCode.PUSHDATA1;
            expectedArray[38] = 0x21;
            Array.Copy(publicKeys[1].EncodePoint(true), 0, expectedArray, 39, 33);
            expectedArray[72] = (byte)OpCode.PUSH2;
            expectedArray[73] = (byte)OpCode.PUSHNULL;
            expectedArray[74] = (byte)OpCode.SYSCALL;
            Array.Copy(BitConverter.GetBytes(ApplicationEngine.Neo_Crypto_CheckMultisigWithECDsaSecp256r1), 0, expectedArray, 75, 4);
