...
namespace Neo.UnitTests.SmartContract
{
    ...
    public class UT_Contract
    {
        ...
        public void TestGetAddress()
        {
            ...
            Array.Copy(BitConverter.GetBytes(InteropService.Neo_Crypto_ECDsaVerify), 0, expectedArray, 37, 4);
        ...
        public void TestCreateMultiSigContract()
        {
            ...
            Array.Copy(BitConverter.GetBytes(InteropService.Neo_Crypto_ECDsaCheckMultiSig), 0, expectedArray, 74, 4);
