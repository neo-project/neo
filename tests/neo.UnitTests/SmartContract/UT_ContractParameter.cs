...
namespace Neo.UnitTests.SmartContract
{
    ...
    public class UT_ContractParameter
    {
        ...
        public void TestGenerator2()
        {
            ...
            byte[] expectedArray6 = new byte[0];
        ...
        {
            ContractParameter contractParameter1 = new ContractParameter();
            ...
            ContractParameter internalContractParameter3 = new ContractParameter(ContractParameterType.Boolean);
            ...
            ContractParameter contractParameter4 = new ContractParameter(ContractParameterType.Map);
            Assert.AreEqual("[]", contractParameter4.ToString());
            ContractParameter internalContractParameter4 = new ContractParameter(ContractParameterType.Boolean);
            ...
            ContractParameter contractParameter5 = new ContractParameter(ContractParameterType.String);
