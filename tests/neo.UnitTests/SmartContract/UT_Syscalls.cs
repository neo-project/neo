    ...
    public class UT_Syscalls
    {
        ...
        public void System_Blockchain_GetBlock()
        {
            ...
            using (var script = new ScriptBuilder())
            {
                ...
                script.EmitSysCall(InteropService.System_Json_Serialize);
        ...
        public void Json_Deserialize()
        {
            ...
            {
                script.EmitPush("123");
                script.EmitSysCall(InteropService.System_Json_Deserialize);
        ...
        public void System_ExecutionEngine_GetScriptContainer()
        {
            ...
            using (var script = new ScriptBuilder())
            {
                script.EmitSysCall(InteropService.System_Runtime_GetScriptContainer);
