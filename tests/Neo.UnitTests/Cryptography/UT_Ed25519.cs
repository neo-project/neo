...
public class UT_Ed25519
{
    ...
    public void TestInvalidPrivateKeySize()
    {
        ...
        Assert.ThrowsExactly<ArgumentException>(() => Ed25519.GetPublicKey(invalidPrivateKey), "Invalid private key size*");
    }
    ...
    public void TestInvalidSignatureSize()
    {
        ...
        Assert.ThrowsExactly<ArgumentException>(() => Ed25519.Verify(publicKey, message, invalidSignature), "Invalid signature size*");
    }
    ...
    public void TestInvalidPublicKeySize()
    {
        ...
        Assert.ThrowsExactly<ArgumentException>(() => Ed25519.Verify(invalidPublicKey, message, signature), "Invalid public key size*");
    }
