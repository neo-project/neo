...
namespace Neo.UnitTests.Cryptography.ECC
{
    ...
    public class UT_ECFieldElement
    {
        ...
        public void TestToByteArray()
        {
            ...
            result[31] = 100;
            Assert.AreSequenceEqual(result, new ECFieldElement(new BigInteger(100), ECCurve.Secp256k1).ToByteArray());

            byte[] result2 = { 2, 53, 250, 221, 129, 194, 130, 43, 179, 240, 120, 119, 151, 61, 80, 242, 139, 242, 42, 49, 190, 142, 232, 0, 0, 0, 0, 0, 0, 0, 0, 0 };
            Assert.AreSequenceEqual(result2, new ECFieldElement(BigInteger.Pow(new BigInteger(10), 75), ECCurve.Secp256k1).ToByteArray());
