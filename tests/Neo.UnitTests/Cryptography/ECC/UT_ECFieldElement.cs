...
namespace Neo.UnitTests.Cryptography.ECC
{
    ...
    public class UT_ECFieldElement
    {
        ...
        public void TestSqrt()
        {
            ...
            ConstructorInfo constructor = typeof(ECCurve).GetConstructor(BindingFlags.NonPublic | BindingFlags.Instance, null,
                [typeof(BigInteger), typeof(BigInteger), typeof(BigInteger), typeof(BigInteger), typeof(byte[])], null);
