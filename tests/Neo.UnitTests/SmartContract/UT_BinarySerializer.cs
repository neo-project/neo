...
public class UT_BinarySerializer
{
    ...
    public void TestSerialize()
    {
        ...
        Assert.ThrowsExactly<NotSupportedException>(() => BinarySerializer.Serialize(stackItem4, ExecutionEngineLimits.Default));
        ...
        Assert.ThrowsExactly<NotSupportedException>(() => BinarySerializer.Serialize(stackItem91, ExecutionEngineLimits.Default));

        Array stackItem10 = new();
        stackItem10.Add(stackItem10);
        Assert.ThrowsExactly<NotSupportedException>(() => BinarySerializer.Serialize(stackItem10, ExecutionEngineLimits.Default));
    }
    ...
    public void TestDeserializeStackItem()
    {
        ...
        byteArray4[0] = 0x40;
        Assert.ThrowsExactly<FormatException>(() => BinarySerializer.Deserialize(byteArray4, ExecutionEngineLimits.Default));
