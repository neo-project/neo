    ...
    public class UT_NativeContract
    {
        ...
        public void TestSetup()
        {
            ...
            _nativeStates = new Dictionary<string, string>
            {
                ...
                {"PolicyContract", """{"id":-7,"updatecounter":0,"hash":"0xcc5e4edd9f5f8dba8bb65734541df7a1c081c67b","nef":{"magic":860243278,"compiler":"neo-core-v3.0","source":"","tokens":[],"script":"EEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dA","checksum":1171474237},"manifest":{"name":"PolicyContract","groups":[],"features":{},"supportedstandards":[],"abi":{"methods":[{"name":"blockAccount","parameters":[{"name":"account","type":"Hash160"}],"returntype":"Boolean","offset":0,"safe":false},{"name":"enableHardfork","parameters":[{"name":"hardfork","type":"Integer"}],"returntype":"Void","offset":7,"safe":false},{"name":"getAttributeFee","parameters":[{"name":"attributeType","type":"Integer"}],"returntype":"Integer","offset":14,"safe":true},{"name":"getBlockedAccounts","parameters":[],"returntype":"InteropInterface","offset":21,"safe":true},{"name":"getExecFeeFactor","parameters":[],"returntype":"Integer","offset":28,"safe":true},{"name":"getExecPicoFeeFactor","parameters":[],"returntype":"Integer","offset":35,"safe":true},{"name":"getFeePerByte","parameters":[],"returntype":"Integer","offset":42,"safe":true},{"name":"getHardfork","parameters":[{"name":"hardfork","type":"Integer"}],"returntype":"Integer","offset":49,"safe":true},{"name":"getMaxTraceableBlocks","parameters":[],"returntype":"Integer","offset":56,"safe":true},{"name":"getMaxValidUntilBlockIncrement","parameters":[],"returntype":"Integer","offset":63,"safe":true},{"name":"getMillisecondsPerBlock","parameters":[],"returntype":"Integer","offset":70,"safe":true},{"name":"getPublicNetwork","parameters":[],"returntype":"Integer","offset":77,"safe":true},{"name":"getStoragePrice","parameters":[],"returntype":"Integer","offset":84,"safe":true},{"name":"getWhitelistFeeContracts","parameters":[],"returntype":"InteropInterface","offset":91,"safe":true},{"name":"isBlocked","parameters":[{"name":"account","type":"Hash160"}],"returntype":"Boolean","offset":98,"safe":true},{"name":"recoverFund","parameters":[{"name":"account","type":"Hash160"},{"name":"token","type":"Hash160"}],"returntype":"Boolean","offset":105,"safe":false},{"name":"removeWhitelistFeeContract","parameters":[{"name":"contractHash","type":"Hash160"},{"name":"method","type":"String"},{"name":"argCount","type":"Integer"}],"returntype":"Void","offset":112,"safe":false},{"name":"setAttributeFee","parameters":[{"name":"attributeType","type":"Integer"},{"name":"value","type":"Integer"}],"returntype":"Void","offset":119,"safe":false},{"name":"setExecFeeFactor","parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","offset":126,"safe":false},{"name":"setFeePerByte","parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","offset":133,"safe":false},{"name":"setMaxTraceableBlocks","parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","offset":140,"safe":false},{"name":"setMaxValidUntilBlockIncrement","parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","offset":147,"safe":false},{"name":"setMillisecondsPerBlock","parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","offset":154,"safe":false},{"name":"setPublicNetwork","parameters":[],"returntype":"Void","offset":161,"safe":false},{"name":"setStoragePrice","parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","offset":168,"safe":false},{"name":"setWhitelistFeeContract","parameters":[{"name":"contractHash","type":"Hash160"},{"name":"method","type":"String"},{"name":"argCount","type":"Integer"},{"name":"fixedFee","type":"Integer"}],"returntype":"Void","offset":175,"safe":false},{"name":"unblockAccount","parameters":[{"name":"account","type":"Hash160"}],"returntype":"Boolean","offset":182,"safe":false}],"events":[{"name":"MillisecondsPerBlockChanged","parameters":[{"name":"old","type":"Integer"},{"name":"new","type":"Integer"}]},{"name":"WhitelistFeeChanged","parameters":[{"name":"contract","type":"Hash160"},{"name":"method","type":"String"},{"name":"argCount","type":"Integer"},{"name":"fee","type":"Any"}]},{"name":"RecoveredFund","parameters":[{"name":"account","type":"Hash160"}]},{"name":"HardforkEnabled","parameters":[{"name":"hardfork","type":"Integer"},{"name":"height","type":"Integer"}]},{"name":"PublicNetworkSet","parameters":[{"name":"network","type":"Integer"}]}]},"permissions":[{"contract":"*","methods":"*"}],"trusts":[],"extra":null}}"""},
        ...
        public void TestIsInitializeBlock()
        {
            ...
            Assert.IsTrue(NativeContract.CryptoLib.IsInitializeBlock(settings, snapshot, 0, out var hf));
            Assert.IsNotNull(hf);
            Assert.IsEmpty(hf);

            Assert.IsFalse(NativeContract.CryptoLib.IsInitializeBlock(settings, snapshot, 1, out hf));
            Assert.IsNull(hf);
