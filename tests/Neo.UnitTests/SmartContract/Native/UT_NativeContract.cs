...
public class UT_NativeContract
{
    ...
    public void TestNativeContractId()
    {
        ...
        Assert.AreEqual(-2, NativeContract.TokenManagement.Id);
        Assert.AreEqual(-3, NativeContract.StdLib.Id);
        Assert.AreEqual(-4, NativeContract.CryptoLib.Id);
        Assert.AreEqual(-5, NativeContract.Ledger.Id);
        Assert.AreEqual(-6, NativeContract.NEO.Id);
        Assert.AreEqual(-7, NativeContract.GAS.Id);
        Assert.AreEqual(-8, NativeContract.Policy.Id);
        Assert.AreEqual(-9, NativeContract.RoleManagement.Id);
        Assert.AreEqual(-10, NativeContract.Oracle.Id);
        Assert.AreEqual(-11, NativeContract.Notary.Id);
        Assert.AreEqual(-12, NativeContract.Treasury.Id);
    }
