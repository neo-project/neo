...
namespace Neo.UnitTests.SmartContract.Manifest
{
    ...
    public class UT_ContractPermission
    {
        ...
        {
            // null
            var contractPermission = ContractPermission.DefaultPermission;
            var s = (Struct)contractPermission.ToStackItem(new VM.ReferenceCounter());
        ...
        {
            var contractManifest1 = TestUtils.CreateDefaultManifest();
            var contractPermission1 = ContractPermission.DefaultPermission;
            ...
            var contractManifest2 = TestUtils.CreateDefaultManifest();
            var contractPermission2 = ContractPermission.DefaultPermission;
            ...
            Random random = new();
            var privateKey3 = new byte[32];
            random.NextBytes(privateKey3);
            var publicKey3 = ECCurve.Secp256r1.G * privateKey3;
            var contractManifest3 = TestUtils.CreateDefaultManifest();
            contractManifest3.Groups = new ContractGroup[] { new ContractGroup() { PubKey = publicKey3 } };
            var contractPermission3 = ContractPermission.DefaultPermission;
            ...
            var privateKey41 = new byte[32];
            random.NextBytes(privateKey41);
            var publicKey41 = ECCurve.Secp256r1.G * privateKey41;
            var privateKey42 = new byte[32];
            random.NextBytes(privateKey42);
            var publicKey42 = ECCurve.Secp256r1.G * privateKey42;
            var contractManifest4 = TestUtils.CreateDefaultManifest();
            contractManifest4.Groups = new ContractGroup[] { new ContractGroup() { PubKey = publicKey42 } };
            var contractPermission4 = ContractPermission.DefaultPermission;
