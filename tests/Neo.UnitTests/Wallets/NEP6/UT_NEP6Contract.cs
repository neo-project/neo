...
namespace Neo.UnitTests.Wallets.NEP6
{
    ...
    public class UT_NEP6Contract
    {
        ...
        public void TestFromJson()
        {
            ...
            JObject @object = JToken.Parse(json).GetObject();
        ...
        public void TestToJson()
        {
            ...
            jString = (JString)parameters[0].GetObject()["name"];
            jString.Value.Should().Be("param1");
            jString = (JString)parameters[0].GetObject()["type"];
            jString.Value.Should().Be(ContractParameterType.Boolean.ToString());

            jString = (JString)parameters[1].GetObject()["name"];
            jString.Value.Should().Be("param2");
            jString = (JString)parameters[1].GetObject()["type"];
