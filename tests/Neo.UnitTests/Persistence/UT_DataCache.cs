...
namespace Neo.UnitTests.IO.Caching
{
    ...
    public class UT_DataCache
    {
        ...
        public void TestStorageItemDuringConstructor()
        {
            ...
            {
                clone.Add(new StorageKey([0, 1, 2, 3, 4, 5]), new StorageItem(manifest));
            });
            clone.Commit();
        }
