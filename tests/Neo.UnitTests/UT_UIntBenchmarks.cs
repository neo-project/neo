...
namespace Neo.UnitTests
{
    ...
    public class UT_UIntBenchmarks
    {
        ...
        {
            var uint160strbig = "0x0001020304050607080900010203040506070809";
            var num1 = UInt160.Parse(uint160strbig);
            num1.ToString().Should().Be("0x0001020304050607080900010203040506070809");

            var uint160strbig2 = "0X0001020304050607080900010203040506070809";
            var num2 = UInt160.Parse(uint160strbig2);
        ...
        public void Benchmark_CompareTo_UInt256()
        {
            ...
            var uut_32_1 = new UInt256[MAX_TESTS];
            var uut_32_2 = new UInt256[MAX_TESTS];
        ...
        public void Benchmark_CompareTo_UInt160()
        {
            ...
            var uut_20_1 = new UInt160[MAX_TESTS];
            var uut_20_2 = new UInt160[MAX_TESTS];
