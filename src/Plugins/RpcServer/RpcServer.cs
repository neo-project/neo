...
namespace Neo.Plugins.RpcServer
{
    public class RpcServer : Plugin
    {
        ...
        private static readonly Dictionary<uint, Server> servers = new();
        ...
        protected override void Configure()
        {
            ...
            foreach (RpcServerSettings s in settings.Servers)
                if (servers.TryGetValue(s.Network, out Server server))
        ...
        protected override void OnSystemLoaded(NeoSystem system)
        {
            ...
            Server rpcRpcServer = new(system, s);
        ...
        {
            if (servers.TryGetValue(network, out Server server))
            {
