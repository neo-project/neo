...
namespace Neo.Plugins.StateService.Verification
{
    class VerificationContext
    {
        ...
        public VerificationContext(Wallet wallet, uint index)
        {
            ...
            myIndex = -1;
            rootIndex = index;
            verifiers = NativeContract.RoleManagement.GetDesignatedByRole(StateService._system.StoreView, Role.StateValidator, index);
        ...
        private ExtensiblePayload CreateVoteMessage()
        {
            ...
            {
                sig = StateRoot.Sign(keyPair, StateService._system.Settings.Network);
        ...
        public bool AddSignature(int index, byte[] sig)
        {
            ...
            byte[] hash_data = StateRoot?.GetSignData(StateService._system.Settings.Network);
        ...
        public bool CheckSignatures()
        {
            ...
            if (StateRoot.Witness is null)
            {
                ...
                ContractParametersContext sc = new(StateService._system.StoreView, StateRoot, StateService._system.Settings.Network);
        ...
        private ExtensiblePayload CreatePayload(MessageType type, ISerializable payload, uint validBlockEndThreshold)
        {
            ...
            {
                Category = StateService.StatePayloadCategory,
            ...
            ContractParametersContext sc = new ContractParametersContext(StateService._system.StoreView, msg, StateService._system.Settings.Network);
            wallet.Sign(sc);
