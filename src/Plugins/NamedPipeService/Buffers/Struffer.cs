...
{
    internal sealed class Stuffer : IEnumerable<byte>
    {
        ...
        public Stuffer Write<T>(T value)
            where T : unmanaged
        {
        ...
        public Stuffer Write<T>(T[] values)
            where T : unmanaged
        {
            Write(values.Length);
        ...
        public Stuffer Write(string value)
        {
