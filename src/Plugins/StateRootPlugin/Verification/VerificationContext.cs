...
namespace Neo.Plugins.StateRootPlugin.Verification
{
    class VerificationContext
    {
        ...
        public VerificationContext(Wallet wallet, uint index)
        {
            ...
            myIndex = -1;
            rootIndex = index;
            verifiers = NativeContract.RoleManagement.GetDesignatedByRole(StateRootPlugin.NeoSystem.StoreView, Role.StateValidator, index);
        ...
        private ExtensiblePayload CreateVoteMessage()
        {
            ...
            {
                sig = StateRoot.Sign(keyPair, StateRootPlugin.NeoSystem.Settings.Network);
        ...
        public bool AddSignature(int index, byte[] sig)
        {
            ...
            var hashData = StateRoot?.GetSignData(StateRootPlugin.NeoSystem.Settings.Network);
        ...
        public bool CheckSignatures()
        {
            ...
            if (StateRoot.Witness is null)
            {
                ...
                var sc = new ContractParametersContext(StateRootPlugin.NeoSystem.StoreView, StateRoot, StateRootPlugin.NeoSystem.Settings.Network);
        ...
        private ExtensiblePayload CreatePayload(MessageType type, ISerializable payload, uint validBlockEndThreshold)
        {
            ...
            {
                Category = StateRootPlugin.StatePayloadCategory,
            ...
            var sc = new ContractParametersContext(StateRootPlugin.NeoSystem.StoreView, msg, StateRootPlugin.NeoSystem.Settings.Network);
            wallet.Sign(sc);
