...
namespace Neo.Extensions
{
    public static class ReadOnlyViewExtensions
    {
        ...
        /// 
        /// If want to scan all entries with backward, 
        ...
        /// <param name="maxSizeWhenAll0xff">
        /// The maximum size when all bytes are 0xff.
        /// If the key prefix is all 0xff, and <paramref name="maxSizeWhenAll0xff"/> > 0,
        /// the seek prefix will be set to be byte[maxSizeWhenAll0xff] and filled with 0xff.
        /// If <paramref name="maxSizeWhenAll0xff"/> is less than or equal to 0, an ArgumentException will be thrown.
        /// </param>
