        ...
        private void OnInventoryReceived(IInventory inventory)
        {
            ...
            switch (inventory)
            {
                case Transaction transaction:
                    if (!(system.ContainsTransaction(transaction.Hash) != ContainsTransactionType.NotExists || system.ContainsConflictHash(transaction.Hash, transaction.Signers.Select(s => s.Account))))
