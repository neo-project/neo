...
namespace Neo.SmartContract
{
    ...
    public class DeployedContract : Contract
    {
        ...
        public DeployedContract(ContractState contract)
        {
            ...
            ContractMethodDescriptor descriptor = contract.Manifest.Abi.GetMethod(ContractBasicMethod.Verify, ContractBasicMethod.VerifyPCount) ?? throw new NotSupportedException("The smart contract haven't got verify method.");
