...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            StaticCoefficients[(byte)OpCode.DROP] = 1;
            StaticCoefficients[(byte)OpCode.NIP] = 1;
            StaticCoefficients[(byte)OpCode.XDROP] = 1;
            StaticCoefficients[(byte)OpCode.CLEAR] = 1;
            StaticCoefficients[(byte)OpCode.DUP] = 1;
            StaticCoefficients[(byte)OpCode.OVER] = 1;
            StaticCoefficients[(byte)OpCode.PICK] = 1;
            StaticCoefficients[(byte)OpCode.TUCK] = 1;
            StaticCoefficients[(byte)OpCode.SWAP] = 1;
            StaticCoefficients[(byte)OpCode.ROT] = 1;
            StaticCoefficients[(byte)OpCode.REVERSE3] = 1;
            StaticCoefficients[(byte)OpCode.REVERSE4] = 1;
            StaticCoefficients[(byte)OpCode.REVERSEN] = 1;
            StaticCoefficients[(byte)OpCode.INITSSLOT] = 1;
            StaticCoefficients[(byte)OpCode.INITSLOT] = 1;
            ...
            StaticCoefficients[(byte)OpCode.STSFLD0] = 1;
            StaticCoefficients[(byte)OpCode.STSFLD1] = 1;
            StaticCoefficients[(byte)OpCode.STSFLD2] = 1;
            StaticCoefficients[(byte)OpCode.STSFLD3] = 1;
            StaticCoefficients[(byte)OpCode.STSFLD4] = 1;
            StaticCoefficients[(byte)OpCode.STSFLD5] = 1;
            StaticCoefficients[(byte)OpCode.STSFLD6] = 1;
            StaticCoefficients[(byte)OpCode.STSFLD] = 1;
            ...
            StaticCoefficients[(byte)OpCode.STLOC0] = 1;
            StaticCoefficients[(byte)OpCode.STLOC1] = 1;
            StaticCoefficients[(byte)OpCode.STLOC2] = 1;
            StaticCoefficients[(byte)OpCode.STLOC3] = 1;
            StaticCoefficients[(byte)OpCode.STLOC4] = 1;
            StaticCoefficients[(byte)OpCode.STLOC5] = 1;
            StaticCoefficients[(byte)OpCode.STLOC6] = 1;
            StaticCoefficients[(byte)OpCode.STLOC] = 1;
            ...
            StaticCoefficients[(byte)OpCode.STARG0] = 1;
            StaticCoefficients[(byte)OpCode.STARG1] = 1;
            StaticCoefficients[(byte)OpCode.STARG2] = 1;
            StaticCoefficients[(byte)OpCode.STARG3] = 1;
            StaticCoefficients[(byte)OpCode.STARG4] = 1;
            StaticCoefficients[(byte)OpCode.STARG5] = 1;
            StaticCoefficients[(byte)OpCode.STARG6] = 1;
            StaticCoefficients[(byte)OpCode.STARG] = 1;
            StaticCoefficients[(byte)OpCode.NEWBUFFER] = 1;
            StaticCoefficients[(byte)OpCode.MEMCPY] = 1;
            StaticCoefficients[(byte)OpCode.CAT] = 1;
            StaticCoefficients[(byte)OpCode.SUBSTR] = 1;
            StaticCoefficients[(byte)OpCode.LEFT] = 1;
            StaticCoefficients[(byte)OpCode.RIGHT] = 1;
            ...
            StaticCoefficients[(byte)OpCode.PACKMAP] = 1;
            StaticCoefficients[(byte)OpCode.PACKSTRUCT] = 1;
            StaticCoefficients[(byte)OpCode.PACK] = 1;
            StaticCoefficients[(byte)OpCode.UNPACK] = 1;
            StaticCoefficients[(byte)OpCode.NEWARRAY0] = 2;
            StaticCoefficients[(byte)OpCode.NEWARRAY] = 1;
            StaticCoefficients[(byte)OpCode.NEWSTRUCT0] = 2;
            StaticCoefficients[(byte)OpCode.NEWSTRUCT] = 1;
            StaticCoefficients[(byte)OpCode.NEWMAP] = 2;
            StaticCoefficients[(byte)OpCode.SIZE] = 1;
            StaticCoefficients[(byte)OpCode.HASKEY] = 1;
            StaticCoefficients[(byte)OpCode.KEYS] = 1;
            StaticCoefficients[(byte)OpCode.VALUES] = 1;
            StaticCoefficients[(byte)OpCode.PICKITEM] = 1;
            StaticCoefficients[(byte)OpCode.APPEND] = 1;
            StaticCoefficients[(byte)OpCode.SETITEM] = 1;
            StaticCoefficients[(byte)OpCode.REVERSEITEMS] = 1;
            StaticCoefficients[(byte)OpCode.REMOVE] = 1;
            StaticCoefficients[(byte)OpCode.CLEARITEMS] = 1;
            StaticCoefficients[(byte)OpCode.POPITEM] = 1;
            StaticCoefficients[(byte)OpCode.ISNULL] = 1;
            StaticCoefficients[(byte)OpCode.ISTYPE] = 1;
            StaticCoefficients[(byte)OpCode.CONVERT] = 1;
        }
    }
}
