...
public static class Helper
{
    ...
    /// <summary>
    /// Gets the script hash of the specified <see cref="VM.ExecutionContext"/>.
    /// </summary>
    /// <param name="context">The specified <see cref="VM.ExecutionContext"/>.</param>
    /// <returns>The script hash of the context.</returns>
    public static UInt160 GetScriptHash(this VM.ExecutionContext context)
    {
