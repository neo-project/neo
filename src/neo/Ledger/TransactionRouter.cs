...
namespace Neo.Ledger
{
    internal class TransactionRouter : UntypedActor
    {
        ...
        protected override void OnReceive(object message)
        {
            ...
            system.Blockchain.Tell(new PreverifyCompleted(preverify.Transaction, preverify.Relay, preverify.Transaction.VerifyStateIndependent(system.Settings, system.StoreView.CreateSnapshot())), Sender);
        }
