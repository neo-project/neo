...
namespace Neo.Wallets
{
    ...
    public abstract class Wallet
    {
        ...
        public BigDecimal GetBalance(DataCache snapshot, UInt160 asset_id, params UInt160[] accounts)
        {
            ...
            using ApplicationEngine engine = ApplicationEngine.Run(script, snapshot, settings: ProtocolSettings, gas: (0_20000000L * PolicyContract.MaxExecFeeFactor / PolicyContract.DefaultExecFeeFactor + 1) * accounts.Length);
