...
namespace Neo.SmartContract
{
    partial class ApplicationEngine
    {
        ...
        public static readonly InteropDescriptor System_Blockchain_GetContract = Register("System.Blockchain.GetContract", nameof(GetContract), 0_00033333, 0, CallFlags.ReadStates, true);
