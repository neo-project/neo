...
namespace Neo.SmartContract
{
    partial class ApplicationEngine
    {
        ...
        public static readonly InteropDescriptor System_Storage_GetContext = Register("System.Storage.GetContext", nameof(GetStorageContext), 0_00000013, 0, CallFlags.ReadStates, false);
        public static readonly InteropDescriptor System_Storage_GetReadOnlyContext = Register("System.Storage.GetReadOnlyContext", nameof(GetReadOnlyContext), 0_00000013, 0, CallFlags.ReadStates, false);
        public static readonly InteropDescriptor System_Storage_AsReadOnly = Register("System.Storage.AsReadOnly", nameof(AsReadOnly), 0_00000013, 0, CallFlags.ReadStates, false);
        public static readonly InteropDescriptor System_Storage_Get = Register("System.Storage.Get", nameof(Get), 0_00033333, 0, CallFlags.ReadStates, false);
        public static readonly InteropDescriptor System_Storage_Find = Register("System.Storage.Find", nameof(Find), 0_00033333, 0, CallFlags.ReadStates, false);
        public static readonly InteropDescriptor System_Storage_Put = Register("System.Storage.Put", nameof(Put), 0, 0, CallFlags.WriteStates, false);
        public static readonly InteropDescriptor System_Storage_PutEx = Register("System.Storage.PutEx", nameof(PutEx), 0, 0, CallFlags.WriteStates, false);
        public static readonly InteropDescriptor System_Storage_Delete = Register("System.Storage.Delete", nameof(Delete), 0, 1, CallFlags.WriteStates, false);
