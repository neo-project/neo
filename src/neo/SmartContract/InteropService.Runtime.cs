...
namespace Neo.SmartContract
{
    partial class InteropService
    {
        public static class Runtime
        {
            ...
            public static readonly InteropDescriptor Platform = Register("System.Runtime.Platform", Runtime_Platform, 0_00000025, TriggerType.All, CallFlags.None);
            public static readonly InteropDescriptor GetTrigger = Register("System.Runtime.GetTrigger", Runtime_GetTrigger, 0_00000025, TriggerType.All, CallFlags.None);
            public static readonly InteropDescriptor GetTime = Register("System.Runtime.GetTime", Runtime_GetTime, 0_00000025, TriggerType.Application, CallFlags.None);
            public static readonly InteropDescriptor GetScriptContainer = Register("System.Runtime.GetScriptContainer", Runtime_GetScriptContainer, 0_00000025, TriggerType.All, CallFlags.None);
            public static readonly InteropDescriptor GetExecutingScriptHash = Register("System.Runtime.GetExecutingScriptHash", Runtime_GetExecutingScriptHash, 0_00000040, TriggerType.All, CallFlags.None);
            public static readonly InteropDescriptor GetCallingScriptHash = Register("System.Runtime.GetCallingScriptHash", Runtime_GetCallingScriptHash, 0_00000040, TriggerType.All, CallFlags.None);
            public static readonly InteropDescriptor GetEntryScriptHash = Register("System.Runtime.GetEntryScriptHash", Runtime_GetEntryScriptHash, 0_00000040, TriggerType.All, CallFlags.None);
            public static readonly InteropDescriptor CheckWitness = Register("System.Runtime.CheckWitness", Runtime_CheckWitness, 0_00000300, TriggerType.All, CallFlags.None);
            public static readonly InteropDescriptor GetInvocationCounter = Register("System.Runtime.GetInvocationCounter", Runtime_GetInvocationCounter, 0_00000040, TriggerType.All, CallFlags.None);
            public static readonly InteropDescriptor Log = Register("System.Runtime.Log", Runtime_Log, 0_00010000, TriggerType.All, CallFlags.AllowNotify);
            public static readonly InteropDescriptor Notify = Register("System.Runtime.Notify", Runtime_Notify, 0_00010000, TriggerType.All, CallFlags.AllowNotify);
            public static readonly InteropDescriptor GetNotifications = Register("System.Runtime.GetNotifications", Runtime_GetNotifications, 0_00000100, TriggerType.All, CallFlags.None);
