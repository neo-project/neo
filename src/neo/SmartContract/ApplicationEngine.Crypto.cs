...
namespace Neo.SmartContract
{
    partial class ApplicationEngine
    {
        ...
        public static readonly InteropDescriptor Neo_Crypto_Hash160 = Register("Neo.Crypto.Hash160", nameof(Hash160), 0_01000000, TriggerType.All, CallFlags.None);
        public static readonly InteropDescriptor Neo_Crypto_Hash256 = Register("Neo.Crypto.Hash256", nameof(Hash256), 0_01000000, TriggerType.All, CallFlags.None);
        ...
        internal byte[] Hash160(StackItem item)
        {
            ...
            return value.Sha256().RIPEMD160();
        }

        internal byte[] Hash256(StackItem item)
        {
            ReadOnlySpan<byte> value = item switch
            {
                InteropInterface _interface => _interface.GetInterface<IVerifiable>().GetHashData(),
