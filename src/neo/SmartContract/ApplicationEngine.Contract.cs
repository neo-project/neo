...
namespace Neo.SmartContract
{
    partial class ApplicationEngine
    {
        ...
        public static readonly InteropDescriptor System_Contract_CreateStandardMultisigAccount = Register("System.Contract.CreateStandardMultisigAccount", nameof(CreateStandardMultisigAccount), 1 << 8, CallFlags.None);
