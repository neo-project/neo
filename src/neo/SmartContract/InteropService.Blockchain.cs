...
namespace Neo.SmartContract
{
    partial class InteropService
    {
        ...
        {
            public static readonly InteropDescriptor GetHeight = Register("System.Blockchain.GetHeight", Blockchain_GetHeight, 0_00000040, TriggerType.Application, CallFlags.None);
            public static readonly InteropDescriptor GetBlock = Register("System.Blockchain.GetBlock", Blockchain_GetBlock, 0_00025000, TriggerType.Application, CallFlags.None);
            public static readonly InteropDescriptor GetTransaction = Register("System.Blockchain.GetTransaction", Blockchain_GetTransaction, 0_00010000, TriggerType.Application, CallFlags.None);
            public static readonly InteropDescriptor GetTransactionHeight = Register("System.Blockchain.GetTransactionHeight", Blockchain_GetTransactionHeight, 0_00010000, TriggerType.Application, CallFlags.None);
            public static readonly InteropDescriptor GetTransactionFromBlock = Register("System.Blockchain.GetTransactionFromBlock", Blockchain_GetTransactionFromBlock, 0_00010000, TriggerType.Application, CallFlags.None);
            public static readonly InteropDescriptor GetContract = Register("System.Blockchain.GetContract", Blockchain_GetContract, 0_00010000, TriggerType.Application, CallFlags.None);
