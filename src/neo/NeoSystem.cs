...
namespace Neo
{
    public class NeoSystem : IDisposable
    {
        ...
        public void StartConsensus(Wallet wallet, IStore consensus_store = null, bool ignoreRecoveryLogs = false)
        {
            ...
            Consensus = ActorSystem.ActorOf(ConsensusService.Props(this.LocalNode, this.TaskManager, this.Blockchain, consensus_store ?? store, wallet).WithDispatcher("customDispatcher"));
