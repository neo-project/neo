...
//
// CandidateCommand.Unvote.cs file belongs to the neo project and is free
...
namespace Neo.Hosting.App.CommandLine.Prompt
{
    ...
    {
        internal sealed class UnvoteCommand : Command
        {
            public UnvoteCommand() : base("unvote", "Remove your vote")
            {
