...
//
// Nep17Command.Decimals.cs file belongs to the neo project and is free
...
namespace Neo.Hosting.App.CommandLine.Prompt
{
    ...
    {
        internal sealed class DecimalsCommand : Command
        {
            public DecimalsCommand() : base("decimals", "Get decimals of the token")
            {
