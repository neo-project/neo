...
//
// Nep17Command.TotalSupply.cs file belongs to the neo project and is free
...
namespace Neo.Hosting.App.CommandLine.Prompt
{
    ...
    {
        internal sealed class TotalSupplyCommand : Command
        {
            public TotalSupplyCommand() : base("totalsupply", "Get the total supply of the token")
            {
