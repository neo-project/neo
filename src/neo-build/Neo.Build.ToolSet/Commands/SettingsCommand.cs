...
//
// SettingsCommand.cs file belongs to the neo project and is free
...
namespace Neo.Build.ToolSet.Commands
{
    ...
    {
        public SettingsCommand() : base("settings", "View environment settings")
        {
        ...
        public new sealed class Handler(
            ...
            INeoConfigurationOptions configurationOptions) : ICommandHandler
        {
            private readonly IHostEnvironment _env = env;
            private readonly INeoConfigurationOptions _configurationOptions = configurationOptions;
