...
//
// NeoBuildConsoleLogger.cs file belongs to the neo project and is free
...
namespace Neo.Build.ToolSet.Logging
{
    internal class NeoBuildConsoleLogger : ILogger
    {
        private readonly string _name;
        private readonly IConsole _console;

        public NeoBuildConsoleLogger(string name, IConsole console)
        {
            _name = name;
            _console = console;
        }
