...
{
    public static readonly Fp2 GeneratorX = new(Fp.FromRawUnchecked(
    [
    ...
    public static readonly Fp2 GeneratorY = new(Fp.FromRawUnchecked(
    [
    ...
    public static readonly Fp2 B = new(Fp.FromRawUnchecked(
    [
    ...
    // 1 / ((u+1) ^ ((q-1)/3))
    public static readonly Fp2 PsiCoeffX = new(in Fp.Zero, Fp.FromRawUnchecked(
    [
        0x890dc9e4867545c3,
        0x2af322533285a5d5,
        0x50880866309b7e2c,
    ...
    // 1 / ((u+1) ^ (p-1)/2)
    public static readonly Fp2 PsiCoeffY = new(Fp.FromRawUnchecked(
    [
        0x3e2f585da55c9ad1,
        0x4294213d86c18183,
        0x382844c88b623732,
    ...
    // 1 / 2 ^ ((q-1)/3)
    public static readonly Fp2 Psi2CoeffX = new(Fp.FromRawUnchecked(
    [
        0xcd03c9e48671f071,
        0x5dab22461fcda5d2,
        0x587042afd3851b95,
