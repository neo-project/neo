...
static class ScalarConstants
{
    ...
    public static readonly Scalar GENERATOR = new(
    [
    ...
    // R = 2^256 mod q
    public static readonly Scalar R = new(
    [
    ...
    // R^2 = 2^512 mod q
    public static readonly Scalar R2 = new(
    [
    ...
    // R^3 = 2^768 mod q
    public static readonly Scalar R3 = new(
    [
    ...
    public static readonly Scalar ROOT_OF_UNITY = new(
    [
