...
using Neo.Types.Interfaces;
using Neo.Types.Utilities;
...
namespace Neo.Cryptography.ECC
{
    ...
    /// </summary>
    public class ECPoint : IComparable<ECPoint>, IEquatable<ECPoint>, ISerializable, IECPoint
    {
        public ECFieldElement X, Y;
        ...
        private static ECPointCache<ECPoint> pointCacheK1 { get; } = new(1000);
        private static ECPointCache<ECPoint> pointCacheR1 { get; } = new(1000);
        ...
        {
            ECPointCache<ECPoint> pointCache = null;
            if (curve == ECCurve.Secp256k1) pointCache = (ECPointCache<ECPoint>)pointCacheK1;
            else if (curve == ECCurve.Secp256r1) pointCache = (ECPointCache<ECPoint>)pointCacheR1;
        ...
        void ISerializable.Deserialize(ref MemoryReader.MemoryReader reader)
        {
        ...
        public static ECPoint DeserializeFrom(ref MemoryReader.MemoryReader reader, ECCurve curve)
        {
        ...
        public static ECPoint FromBytes(byte[] bytes, ECCurve curve)
        {
            return bytes.Length switch
            {
                ...
                64 or 72 => DecodePoint(Utility.Utility.Concat(new byte[] { 0x04 }, bytes[^64..]), curve),
                96 or 104 => DecodePoint(Utility.Utility.Concat(new byte[] { 0x04 }, bytes[^96..^32]), curve),
