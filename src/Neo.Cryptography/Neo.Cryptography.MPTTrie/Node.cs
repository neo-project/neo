...
namespace Neo.Cryptography.MPTTrie
{
    public partial class Node : ISerializable
    {
        ...
        public UInt256 Hash => hash ??= new UInt256(Utility.Utility.Hash256(this.ToArrayWithoutReference()));
        ...
        public byte[] ToArrayWithoutReference()
        {
            ...
            using BinaryWriter writer = new BinaryWriter(ms, Neo.Utility.StrictUTF8, true);
