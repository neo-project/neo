...
//
// OldDataCache.cs file belongs to the neo project and is free
...
namespace Neo.Persistence
{
    ...
    /// </summary>
    public class OldDataCache : IReadOnlyStoreView
    {
        /// <summary>
        ...
        public OldDataCache(IStore store)
        {
            _store = store;
        }
        ...
        /// <param name="key">The key of the entry.</param>
        /// <param name="value">The data of the entry.</param>
        protected void AddInternal(StorageKey key, StorageItem value)
        {
        ...
        /// </summary>
        /// <param name="key">The key of the entry.</param>
        protected void DeleteInternal(StorageKey key)
        {
        ...
        protected bool ContainsInternal(StorageKey key)
        {
        ...
        /// <exception cref="KeyNotFoundException">If the entry doesn't exist.</exception>
        protected StorageItem GetInternal(StorageKey key)
        {
#pragma warning disable CS0618 // Type or member is obsolete
            return _store.TryGet(key.ToArray());
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        /// <param name="direction">The direction of seek.</param>
        /// <returns>An enumerator containing all the entries after seeking.</returns>
        protected IEnumerable<(StorageKey Key, StorageItem Value)> SeekInternal(byte[] keyOrPrefix, SeekDirection direction)
        {
            return _store.Seek(keyOrPrefix, direction).Select(s => (new StorageKey(s.Key), new StorageItem(s.Value)));
        }
        ...
        protected StorageItem? TryGetInternal(StorageKey key)
        {
#pragma warning disable CS0618 // Type or member is obsolete
            return _store.TryGet(key.ToArray());
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        /// <param name="key">The key of the entry.</param>
        /// <param name="value">The data of the entry.</param>
        protected void UpdateInternal(StorageKey key, StorageItem value)
        {
            _store.Put(key.ToArray(), value.ToArray());
        }
    }
