...
//
// Benchmarks.ArrayStack.cs file belongs to the neo project and is free
...
{
    [MemoryDiagnoser]
    public class ArrayStackBenchmarks
    {
    ...
    /// <summary>
    /// Simple demonstration of array-based stack performance improvements
    /// </summary>
    public class SimpleArrayStackBenchmark
    {
        public static void RunBenchmark()
        {
            ...
            Console.WriteLine("=== Neo VM Array-Based Stack Performance Benchmark ===\n");
            ...
            Console.WriteLine($"   List-Based Stack:  {listTime:F2} ms");
            Console.WriteLine($"   Array-Based Stack: {arrayTime:F2} ms");
            ...
            Console.WriteLine($"   List-Based Stack:  {listTime2:F2} ms");
            Console.WriteLine($"   Array-Based Stack: {arrayTime2:F2} ms");
            ...
            Console.WriteLine($"• {Math.Abs(speedup2):F1}x performance change for insert operations");
            ...
            Console.WriteLine("• Direct array access without List overhead");
        }
    }
}