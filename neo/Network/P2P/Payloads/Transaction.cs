...
namespace Neo.Network.P2P.Payloads
{
    public class Transaction : IEquatable<Transaction>, IInventory
    {
        ...
        public void DeserializeUnsigned(BinaryReader reader)
        {
            ...
            var cosigners = Attributes.Where(p => p.Usage == TransactionAttributeUsage.Cosigner).Select(p => p.Data.AsSerializable<CosignerUsage>().ScriptHash).ToArray();
        ...
        public UInt160[] GetScriptHashesForVerifying(Snapshot snapshot)
        {
            ...
            hashes.UnionWith(Attributes.Where(p => p.Usage == TransactionAttributeUsage.Cosigner).Select(p => p.Data.AsSerializable<CosignerUsage>().ScriptHash));
