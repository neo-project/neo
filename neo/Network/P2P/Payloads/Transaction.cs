...
namespace Neo.Network.P2P.Payloads
{
    public class Transaction : IEquatable<Transaction>, IInventory, IInteroperable
    {
        ...
        public virtual bool Reverify(SnapshotView snapshot, BigInteger totalSenderFeeFromPool)
        {
        ...
        bool IInventory.Verify(SnapshotView snapshot)
        {
            return Verify(snapshot, BigInteger.Zero);
        }

        public virtual bool Verify(SnapshotView snapshot, BigInteger totalSenderFeeFromPool)
        {
