...
namespace Neo.Network.RPC
{
    ...
    public class TransactionManager
    {
        ...
        private long EstimateNetworkFee()
        {
            ...
            {
                size += 166;
                networkFee += ApplicationEngine.OpCodePrices[OpCode.PUSHBYTES64] + ApplicationEngine.OpCodePrices[OpCode.PUSHBYTES33] + InteropService.GetPrice(InteropService.Neo_Crypto_ECDsa_Verify, null);
            }
