...
namespace Neo.Wallets.NEP6
{
    public class NEP6SimpleWallet : Wallet
    {
        ...
        public override WalletAccount CreateAccount(byte[] privateKey)
        {
            ...
            NEP6Account account = new NEP6Account(this, contract.ScriptHash, key, password, this.Scrypt)
            {
                Contract = contract
            };
        ...
        public override WalletAccount CreateAccount(Contract contract, KeyPair key = null)
        {
            ...
            if (key == null)
                ...
                account = new NEP6Account(this, nep6contract.ScriptHash, key, password, this.Scrypt);
        ...
        public override WalletAccount Import(string nep2, string passphrase)
        {
            ...
            if (Scrypt.N == 16384 && Scrypt.R == 8 && Scrypt.P == 8)
                ...
                account = new NEP6Account(this, contract.ScriptHash, key, passphrase, this.Scrypt);
        ...
        public override bool VerifyPassword(string password)
        {
            lock (accounts)
            {
                ...
                else
                {
                    try
                    {
                        account.GetKey(password, Scrypt);
                        return true;
                    }
