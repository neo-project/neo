...
namespace Neo.Consensus
{
    public sealed class ConsensusService : UntypedActor
    {
        ...
        private void OnPrepareRequestReceived(ConsensusPayload payload, PrepareRequest message)
        {
            ...
            Log($"{nameof(OnPrepareRequestReceived)}: height={payload.BlockIndex} view={message.ViewNumber} index={payload.ValidatorIndex} tx={message.TransactionHashes.Length} hash={payload.Hash}");
