...
namespace Neo.Persistence.LevelDB
{
    public class LevelDBStore : Store, IDisposable
    {
        ...
        public LevelDBStore(string path)
        {
            ...
            if (db.TryGet(ReadOptions.Default, SliceBuilder.Begin(Prefixes.SYS_Version), out Slice value) && Version.TryParse(value.ToString(), out Version version) && version >= Version.Parse("3.0.0"))
                return;
