...
namespace Neo.SmartContract.Native.Tokens
{
    public sealed class NeoToken : Nep5Token<NeoToken.AccountState>
    {
        ...
        {
            UInt160 account = new UInt160(args[0].GetByteArray().ToArray());
        ...
        {
            ECPoint pubkey = args[0].GetByteArray().Span.AsSerializable<ECPoint>();
        ...
        {
            UInt160 account = new UInt160(args[0].GetByteArray().ToArray());
            ECPoint[] pubkeys = ((VMArray)args[1]).Select(p => p.GetByteArray().Span.AsSerializable<ECPoint>()).ToArray();
        ...
        public class AccountState : Nep5AccountState
        {
            ...
            protected override void FromStruct(Struct @struct)
            {
                ...
                Votes = @struct[2].GetByteArray().Span.AsSerializableArray<ECPoint>(Blockchain.MaxValidators);
            }
