...
namespace Neo.SmartContract.Native.Tokens
{
    public sealed class NeoToken : Nep5Token<NeoToken.AccountState>
    {
        ...
        public override BigInteger TotalSupply(View snapshot)
        {
            return TotalAmount;
        }
        ...
        private BigInteger CalculateBonus(View snapshot, BigInteger value, uint start, uint end)
        {
        ...
        public BigInteger UnclaimedGas(View snapshot, UInt160 account, uint end)
        {
        ...
        private bool RegisterValidator(View snapshot, ECPoint pubkey)
        {
        ...
        public IEnumerable<(ECPoint PublicKey, BigInteger Votes)> GetRegisteredValidators(View snapshot)
        {
        ...
        public ECPoint[] GetValidators(View snapshot)
        {
        ...
        public ECPoint[] GetNextBlockValidators(View snapshot)
        {
