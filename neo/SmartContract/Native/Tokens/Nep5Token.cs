...
namespace Neo.SmartContract.Native.Tokens
{
        ...
        where TState : Nep5AccountState, new()
    {
        ...
        [ContractMethod(0, ContractParameterType.String, Name = "name", ReadOnly = true)]
        protected StackItem NameMethod(ApplicationEngine engine, VMArray args)
        {
            return Name;
        }

        [ContractMethod(0, ContractParameterType.String, Name = "symbol", ReadOnly = true)]
        protected StackItem SymbolMethod(ApplicationEngine engine, VMArray args)
        {
            return Symbol;
        }

        [ContractMethod(0, ContractParameterType.Integer, Name = "decimals", ReadOnly = true)]
        ...
        [ContractMethod(0_01000000, ContractParameterType.Integer, ParameterTypes = new[] { ContractParameterType.Hash160 }, ParameterNames = new[] { "account" }, ReadOnly = true)]
