...
namespace Neo.SmartContract.Native.Tokens
{
        ...
        where TState : Nep5AccountState, new()
    {
        ...
        {
            return BalanceOf(engine.Snapshot, new UInt160(args[0].GetByteArray().ToArray()));
        }
        ...
        {
            UInt160 from = new UInt160(args[0].GetByteArray().ToArray());
            UInt160 to = new UInt160(args[1].GetByteArray().ToArray());
