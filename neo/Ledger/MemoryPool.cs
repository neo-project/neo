...
namespace Neo.Ledger
{
    public class MemoryPool : IReadOnlyCollection<Transaction>
    {
        ...
        internal bool LoadPolicy(SnapshotView snapshot)
        {
        ...
        private int ReverifyTransactions(SortedSet<PoolItem> verifiedSortedTxPool,
            SortedSet<PoolItem> unverifiedSortedTxPool, int count, double millisecondsTimeout, SnapshotView snapshot)
        {
        ...
        internal bool ReVerifyTopUnverifiedTransactionsIfNeeded(int maxToVerify, SnapshotView snapshot)
        {
